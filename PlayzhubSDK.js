...
(function () {
    ...
    class PlayzhubSDk {
        constructor() {
            this.baseUrl = 'https://stg-api.playzhub.com';
            ...
            this.signingServiceUrl = "https://stg-api.playzhub.com/sec/sign-request"
        ...
        sendMessageForAnalytics(eventName, message) {
            ...
            try {
                ...
                console.error('[SDK] Internal trigger failed', e);
            }
            ...
            try {
                ...
                console.error('[SDK] postMessage failed', e);
            }

            if (window.flutter_inappwebview) {
                window.flutter_inappwebview.callHandler(
                    'playzhubsdk_event_handler',
                    eventName,
                    data
                );
            }
